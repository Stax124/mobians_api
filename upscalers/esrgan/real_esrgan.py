...
class RealESRGAN(InferenceModel):
    ...
    def generate(self, input_image: Image.Image, upscale_factor: float) -> Image.Image:
        img = np.array(input_image)

        assert self.upsampler is not None, "Upsampler not loaded"
        output, _ = self.upsampler.enhance(img, outscale=upscale_factor)
